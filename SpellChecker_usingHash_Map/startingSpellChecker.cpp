...
int suggest1(int wordLength, const Dictionary& dict, string curWord, int tot_correction);
int suggest2(int wordLength, const Dictionary& dict, string curWord, int tot_correction);
int suggest3(int wordLength, const Dictionary& dict, string curWord, int tot_correction);
